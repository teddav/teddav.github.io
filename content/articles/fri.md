...
This is where **Reed-Solomon encoding** comes in (if you're unfamiliar with it, check out my article: ["Reed-Solomon Codes"](https://teddav.github.io/blog/reed-solomon/)). It introduces **redundancy** that prevents cheating, more on that below.
...
If you need a refresher on field extensions, check out my previous [article on extension fields](https://teddav.github.io/blog/field-extensions/).
